package agh.ii.prinjava.lab06.lst06_05;
 ...
 *
 *
 * Permet de savoir si un truc est nul
 *
 * Si c'est vide Optional.empty()
 *
 * Sinon Optional.of(truc)
 *
 * Aussi on peut faire des Get ou des OfElseThrow
 *
 *
...
public class Main {
    ...
    private static void demo1() {
        ...
        System.out.println("headOf_v1(LIST1): " + head);

        //head = headOf_v1(LIST2); // <- RuntimeException!
        //System.out.println("headOf_v1(LIST2): " + head);
    ...
    private static void demo3() {
        ...
        System.out.println("headOf_v3(LIST1): " + head.orElse(UNKNOWN_HEAD_STRING));

        head = headOf_v3(LIST2);
        System.out.println("headOf_v3(LIST2): " + head.orElse(UNKNOWN_HEAD_STRING));

        head = headOf_v3(LIST3);
        System.out.println("headOf_v3(LIST3): " + head.orElse(UNKNOWN_HEAD_STRING));
    }
